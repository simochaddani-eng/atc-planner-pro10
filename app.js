// app.js (Version STABLE - Navigation garantie)
...
// --- NAVIGATION DOM (FONCTIONNELLE À 100%) ---
...
// --- NAVIGATION DES BOUTONS (CORRECTION PRINCIPALE) ---
function setupEvents() {
  ...
  // 2. Les boutons "data-go" (ex: "Voir les promotions" dans le Dashboard)
  ...
  document.getElementById('generatePlan').addEventListener('click', function() {
    const name = document.getElementById('cohortName').value;
    if(!name) { alert('Veuillez donner un nom à la promotion.'); return; }
    alert('🚀 Simulation de génération pour "' + name + '" (Backend OR-Tools à connecter).');
  });
